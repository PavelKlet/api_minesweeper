...
class MineSweeperSerializer(serializers.ModelSerializer):
    ...
    def validate_width(self, value):
        if value > 30:
            raise serializers.ValidationError("Ширина должна быть"
                                              " меньше или равна 30.")
        return value

    def validate_height(self, value):
        if value > 30:
            raise serializers.ValidationError("Длина должна "
                                              "быть меньше или равна 30.")
        return value
    ...
    def validate_mines_count(self, value):
        ...
        if value > width * height - 1:
            raise serializers.ValidationError("Количество мин должно быть "
                                              "меньше или равно "
                                              "ширина * высота - 1.")
        return value
